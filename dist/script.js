...
/* harmony import */ var _modules_differenc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/differenc */ "./src/js/modules/differenc.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  new _modules_differenc__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').init();
});

/***/ }),

/***/ "./src/js/modules/differenc.js":
/*!*************************************!*\
  !*** ./src/js/modules/differenc.js ***!
  \*************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Differenc; });
...
/*#__PURE__*/
function () {
  function Differenc(oldOfficer, newOfficer, items) {
    _classCallCheck(this, Differenc);
    ...
    value: function bindTriggers(container, items, counter) {
      container.querySelector('.plus').addEventListener('click', function () {
        if (counter !== items.length - 2) {
          ...
          setTimeout(function () {
            return items[items.length - 1].remove();
          }, 1000);
        }
      });
    }
    ...
    value: function checkMailInputs() {
      ...
      mailInputs.forEach(function (input) {
        ...
        input.addEventListener('change', function (e) {
          if (!this.value.match(/[^a-z 0-9 @ - \.]/ig)) {
            e.preventDefault();
          } else {
            this.value = '';
          }
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            ...
            statusMessage.textContent = _this.message.failer;
          }).finally(function () {
            _this.clearInputs();
